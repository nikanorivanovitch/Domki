    ...
    for y in range (0,len(liste_bazar),2):
        ...
        for x in range (0,len(liste_bazar),2):
            if liste_bazar[x]*liste_bazar[x+1]>c:
                ...
                c=c
        liste_rangée.extend([liste_bazar[k],liste_bazar[k+1]])
...
def check() :
    ...
    liste_definitive.extend([0,0,liste_rangée[0],liste_rangée[1]])
    print("+ 1 pièce")
    ...
    for h in range (2,len(liste_rangée),2):
        ...
        for x in range (largeur) :
            for y in range (longueur) :
                ...
                if not c:
                    liste_definitive.extend([x,y,x+liste_rangée[h],liste_rangée[h+1]])
                    print("+ 1 pièce")
                    km=1
